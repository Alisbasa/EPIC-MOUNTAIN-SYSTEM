...
public class RellenarG {
   ...
   static String venta;
    ...
    public JPanel rellenarDeudasPagar() throws IOException {
        ...
        deudas = new JComboBox(LeerExcel.rellenaCB2(rutas.excel+"/DEUDAS A PAGAR.xlsx", "deudasPagar", 1));
    ...
    public JPanel rellenarReducInv() throws IOException {
        ...
        reducInv = new JComboBox(LeerExcel.rellenaCB2(rutas.excel+"/INVENTARIOS.xlsx", "EPIC MOUNTAIN", 0));
   ...
   static public JPanel rellenarDevoluciones(JPanel panelAbuelo) throws IOException {
        try {
            ...
            devolucion = new JComboBox(LeerExcel.obtenerHoja(rutas.excel+"/HISTORIAL DE COMPRAS.xlsx"));
   ...
   static public JPanel rellenarDevoluciones2(String cliente,JPanel panelAbuelo) throws IOException {
        try {
            ...
            ventas = new JComboBox(LeerExcel.rellenaCB2(rutas.excel+"/HISTORIAL DE COMPRAS.xlsx", cliente, 0));
