...
public class inventarioPrincipal extends javax.swing.JFrame {
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        try {
            ...
            EscribirCRM.escribirExcelInv(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, inventario, 13);
            //UNIDADES
            EscribirCRM.escribirCeldaNumerica(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, Integer.valueOf(jtUnidades.getText()), LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 6);

            //TIG
            Double TIG = Double.valueOf(jtPrecio.getText()) / Double.valueOf(monto.getText());
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, TIG, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 5);

            //COSTO UNIDAD
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, Double.valueOf(monto.getText()), LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 7);
            //COSTO NETO
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, Double.valueOf(costoNeto), LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 8);

            //PRECIO BASE UNIDAD
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, Double.valueOf(jtPrecio.getText()), LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 9);

            //PRECIO BASE NETO
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, Double.valueOf(costoBaseNeto), LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 10);

            //PRECIO LOCAL UNIDAD
            Double precioL = (LeerExcel.obtenerCeldaNumerica(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, 9, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2)) * 1.16);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, precioL, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 11);

            //PRECIO LOCAL NETO
            Double precioNeto = EscribirCRM.Mulitplicar(6, 11, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, precioNeto, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 12);

            //COMISION ML
            Double comisionML = ((LeerExcel.obtenerCeldaNumerica(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, 11, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2))) * .15) + 5;
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, comisionML, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 15);

            //COMISION ML NETO
            Double comisionMLN = EscribirCRM.Mulitplicar(6, 15, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, comisionMLN, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 16);

            // IVA UNIDAD
            Double IVA = (LeerExcel.obtenerCeldaNumerica(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, 9, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2)) * 0.16);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, IVA, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 17);

            //IVA NETO
            Double ivaN = EscribirCRM.Mulitplicar(6, 17, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, ivaN, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 18);

            //PRECIO ML
            Double precioML = EscribirCRM.SumarColumnasML(LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 9, 17, 15, rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, precioML, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 13);

            //PRECIOML NETO
            Double precioMLN = EscribirCRM.Mulitplicar(6, 13, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, precioMLN, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 14);

            //UTILIDAD UNIDAD LOCAL
            Double utilidad = EscribirCRM.RestarColumnas(LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 11, 7, 17, rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, utilidad, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 19);

            //UTILIDAD LOCAL NETA
            Double utilidadLN = EscribirCRM.Mulitplicar(6, 19, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), rutas.excel+ "\\INVENTARIOS.xlsx", inventario2);
            EscribirCRM.escribirCeldaDouble(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, utilidadLN, LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2), 20);

            String formula = "SUM(I2:I" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 8);

            String formula2 = "SUM(K2:K" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula2,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 10);

            String formula3 = "SUM(M2:M" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula3,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 12);

            String formula4 = "SUM(O2:O" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula4,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 14);

            String formula5 = "SUM(Q2:Q" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula5,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 16);

            String formula6 = "SUM(S2:S" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula6,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 18);

            String formula7 = "SUM(U2:U" + (LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2, formula7,
                    LeerExcel.contarRenglones(rutas.excel+ "\\INVENTARIOS.xlsx", inventario2) + 1, 20);
