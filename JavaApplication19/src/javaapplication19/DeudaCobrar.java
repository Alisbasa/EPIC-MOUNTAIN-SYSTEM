...
public class DeudaCobrar extends javax.swing.JFrame {
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        try {
            ...
            //ESCRIBIR DEUDAS
            escribirExcel.ruta(rutas.excel+"\\DEUDAS A COBRAR.xlsx", jtNombre.getText(), "FECHA", "MONTO");
            ...
            escribirExcel.escribirCeldaDouble(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Ingresos",Utilidades.roundTwoDecimals(Double.valueOf(dataLibros[3])), LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Ingresos"), 3);
            ...
            //CAMBIAR A RELLENARINGRESOS.ICONOVENTASC AL HACERLO ESTATICO
                //rellenarGastos.botonBorrarDeudorC(rellenarIngresos.iconoLibrosRI, rutas.excel+"\\DEUDAS A COBRAR.xlsx", jtNombre.getText());
