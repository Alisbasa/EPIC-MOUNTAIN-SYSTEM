...
public class packsCT extends javax.swing.JFrame {
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        try {
            ...
            String formula10 = "SUM(G2:G" + LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Gastos") + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\LibrosContables.xlsx", "Gastos", formula10, (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Gastos")+1), 6);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\LibrosContables.xlsx", "Gastos", Double.valueOf(data[3]), LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Gastos"), 3);
            String formula11 = "SUM(D2:D" + LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Gastos") + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\LibrosContables.xlsx", "Gastos", formula11, (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Gastos")+1), 3);
