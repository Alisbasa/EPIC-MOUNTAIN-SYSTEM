...
public class inventarioPrincipalReg extends javax.swing.JFrame {
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        try {
            ...
            EscribirCRM.escribirExcelInv(rutas.excel + "\\Inventario.xlsx", inventario4, inventario, 13);
            //UNIDADES
            EscribirCRM.escribirCeldaNumerica(rutas.excel + "\\Inventario.xlsx", inventario4, Integer.valueOf(jtUnidades.getText()), LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 6);

            //TIG
            Double TIG = Double.valueOf(jtPrecio.getText()) / Double.valueOf(monto.getText());
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, TIG, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 5);

            //COSTO UNIDAD
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, Double.valueOf(monto.getText()), LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 7);
            //COSTO NETO
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, Double.valueOf(costoNeto), LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 8);

            //PRECIO BASE UNIDAD
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, Double.valueOf(jtPrecio.getText()), LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 9);

            //PRECIO BASE NETO
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, Double.valueOf(costoBaseNeto), LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 10);

            //PRECIO LOCAL UNIDAD
            Double precioL = (LeerExcel.obtenerCeldaNumerica(rutas.excel + "\\Inventario.xlsx", inventario4, 9, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4)) * 1.16);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, precioL, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 11);

            //PRECIO LOCAL NETO
            Double precioNeto = EscribirCRM.Mulitplicar(6, 11, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, precioNeto, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 12);

            //COMISION ML
            Double comisionML = ((LeerExcel.obtenerCeldaNumerica(rutas.excel + "\\Inventario.xlsx", inventario4, 11, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4))) * .15) + 5;
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, comisionML, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 15);

            //COMISION ML NETO
            Double comisionMLN = EscribirCRM.Mulitplicar(6, 15, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, comisionMLN, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 16);

            // IVA UNIDAD
            Double IVA = (LeerExcel.obtenerCeldaNumerica(rutas.excel + "\\Inventario.xlsx", inventario4, 9, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4)) * 0.16);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, IVA, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 17);

            //IVA NETO
            Double ivaN = EscribirCRM.Mulitplicar(6, 17, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, ivaN, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 18);

            //PRECIO ML
            Double precioML = EscribirCRM.SumarColumnasML(LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 9, 17, 15, rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, precioML, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 13);

            //PRECIOML NETO
            Double precioMLN = EscribirCRM.Mulitplicar(6, 13, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, precioMLN, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 14);

            //UTILIDAD UNIDAD LOCAL
            Double utilidad = EscribirCRM.RestarColumnas(LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 11, 7, 17, rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, utilidad, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 19);

            //UTILIDAD LOCAL NETA
            Double utilidadLN = EscribirCRM.Mulitplicar(6, 19, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), rutas.excel + "\\Inventario.xlsx", inventario4);
            EscribirCRM.escribirCeldaDouble(rutas.excel + "\\Inventario.xlsx", inventario4, utilidadLN, LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4), 20);

            String formula = "SUM(I2:I" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 8);

            String formula2 = "SUM(K2:K" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula2,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 10);

            String formula3 = "SUM(M2:M" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula3,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 12);

            String formula4 = "SUM(O2:O" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula4,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 14);

            String formula5 = "SUM(Q2:Q" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula5,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 16);

            String formula6 = "SUM(S2:S" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula6,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 18);

            String formula7 = "SUM(U2:U" + (LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel + "\\Inventario.xlsx", inventario4, formula7,
                    LeerExcel.contarRenglones(rutas.excel + "\\Inventario.xlsx", inventario4) + 1, 20);
            ...
            escribirVentas.escribirCeldaDouble(rutas.excel + "\\LibrosContables.xlsx", "Ingresos", Double.valueOf(monto.getText()), LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos"), 3);
            String formulaMonto = "SUM(D2:D" + (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos") + 1) + ")";
            escribirVentas.escribirFormula(rutas.excel + "\\LibrosContables.xlsx", "Ingresos", formulaMonto, (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos") + 1), 3);

            escribirVentas.escribirCeldaDouble(rutas.excel + "\\LibrosContables.xlsx", "Ingresos", Double.valueOf(monto.getText()), LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos"), 6);
            String formulaGan = "SUM(G2:G" + (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos") + 1) + ")";
            escribirVentas.escribirFormula(rutas.excel + "\\LibrosContables.xlsx", "Ingresos", formulaGan, (LeerExcel.contarRenglones(rutas.excel + "\\LibrosContables.xlsx", "Ingresos") + 1), 6);
