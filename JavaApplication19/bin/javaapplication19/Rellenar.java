...
JLabel iconoOkV = new JLabel();
    ...
    public JPanel rellenarVentas() throws IOException {
        ...
        inventario = new JComboBox(LeerExcel.rellenaCB2("src//excel/INVENTARIOS.xlsx", "EPIC MOUNTAIN", 0));
    ...
    public JPanel rellenarDeudasC() throws IOException {
        ...
        deudor = new JComboBox(LeerExcel.obtenerHoja("src//excel/DEUDAS A COBRAR.xlsx"));
