    ...
    void botonBorrar(JLabel boton, JPanel padre, JPanel hijo, int panelIndex, String img) {
        MouseListener botonV = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                padre.updateUI();
                try {
                    Escribir.removeRow("src//excel/LIBROS DE CONTROL.xlsx", "Ingresos", LeerExcel.contarRenglones("src//excel/LIBROS DE CONTROL.xlsx", "Ingresos"));
        ...
        MouseListener botonV = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    //Escribir.removeRow("src//excel/LIBROS DE CONTROL.xlsx", "Gastos", LeerExcel.contarRenglones("src//excel/LIBROS DE CONTROL.xlsx", "Gastos"));
                } catch (IOException ex) {
                    Logger.getLogger(rellenarIngresos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        MouseListener botonV = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    for (int i = 0; i <= LeerExcel.contarRenglones("src//excel/INVENTARIOS.xlsx", inventario7); i++) {
                        if ((LeerExcel.obtenerCelda(filepath, hoja, 0, LeerExcel.contarRenglones(filepath, hoja))).equals(LeerExcel.obtenerCelda("src//excel/INVENTARIOS.xlsx", inventario7, 0, i))) {
                            finder = true;
                            int suma = (int) (LeerExcel.obtenerCeldaNumerica(filepath, hoja, 6, LeerExcel.contarRenglones(filepath, hoja))) + (int) LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, 6, i);
                            Escribir escribirVentas = new Escribir();
                            escribirVentas.escribirCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, suma, i, 6);
                            ...
                            Double precioML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, 13, i);
                            Double iva = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, 17, i);
                            Double comisionML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, 15, i);
                            Double utilidadShop = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario7, 19, i);
        ...
        MouseListener botonV = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    precioExcel = String.valueOf(Utilidades.roundTwoDecimals(LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario8, numeroPlataforma, numeroLista) * (Integer.valueOf(unidades.getSelectedItem().toString()))));
                    JLabel precio = new JLabel();
                    precio.setFont(new Font("Franklin Gothic Demi Cond", Font.PLAIN, 14));
                    precio.setText("$" + precioExcel);
                    //UTILIDADES
                    String utilidadExcel = "precio";
                    utilidadExcel = String.valueOf(Utilidades.roundTwoDecimals(LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario8, 19, numeroLista) * (Integer.valueOf(unidades.getSelectedItem().toString()))));
        ...
        MouseListener botonC = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    EscribirExcel.crearHoja(rutas.excel+"\\DEUDAS A PAGAR.xlsx", inversor.getText(), "FECHA", "MONTO");
        ...
        MouseListener botonI = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    String formula = "SUM(C2:C" + (LeerExcel.contarRenglones(rutas.excel+"\\DEUDAS A PAGAR.xlsx", "DeudasPagar") + 1) + ")";
                    EscribirExcel.escribirFormula(rutas.excel+"\\DEUDAS A PAGAR.xlsx", "DeudasPagar", formula, (LeerExcel.contarRenglones(rutas.excel+"\\DEUDAS A PAGAR.xlsx", "DeudasPagar") + 1), 2);
                    EscribirExcel.crearHoja(rutas.excel+"\\DEUDAS A PAGAR.xlsx", inversorI.getText(), "FECHA", "MONTO");
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    if (deudor.getSelectedItem().toString().equals("Nuevo")) {
                        ...
                        if (Double.valueOf(LeerExcel.obtenerCeldaFormula(rutas.excel+"\\DEUDAS A COBRAR.xlsx", deudor.getSelectedItem().toString(),(LeerExcel.contarRenglones(rutas.excel+"\\DEUDAS A COBRAR.xlsx", deudor.getSelectedItem().toString())+1), 1)) == 0) {
        ...
        MouseListener botonVC = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    precioExcel = String.valueOf(LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario14, numeroPlataforma, numeroLista) * (unidades.getSelectedIndex() + 1));

                    String utilidadExcel = "precio";

                    utilidadExcel = String.valueOf(Utilidades.roundTwoDecimals(LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario14, 19, numeroLista) * (Integer.valueOf(unidades.getSelectedItem().toString()))));
...
//                
    ...
    public void vender(JComboBox inventario, JComboBox unidadesCB, JComboBox medioVenta, String cliente, JComboBox clienteCB) throws IOException {
        ...
        try {
            ...
            Double precioShop = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 11, seleccion);
            ...
            Double precioShopN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 12, seleccion);
            ...
            Double precioML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 13, seleccion);
            ...
            Double precioMLN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 14, seleccion);
            ...
            Double comisionML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 15, seleccion);
            ...
            Double comisionMLN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 16, seleccion);
            ...
            //Escribe IVA * unidad
            Double iva = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 17, seleccion);
            ...
            Double utilidadShop = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 19, seleccion);
            ...
            Double utilidadShopN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, 20, seleccion);
            ...
            // escribirVentas.borrarCelda("src//excel/INVENTARIOS.xlsx", "Inventario", unidadesCB.getSelectedIndex(), 6);
            if (restaUnidades == 0) {
                Escribir.removeRow("src//excel/INVENTARIOS.xlsx", inventario9, inventario.getSelectedIndex() + 1);
            } else {
                escribirVentas.escribirCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario9, restaUnidades, inventario.getSelectedIndex() + 1, 6);
                //COSTO NETO
    ...
    public void devolver(JComboBox devo) throws IOException {
        ...
        try {
            ...
            //Escribe precio shop*unidad como double
            Double precioShop = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 11, seleccion);
            ...
            //Escribe precio shop neto como doble
            Double precioShopN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 12, seleccion);
            ...
            //Escribe precio Ml por unidad como doble
            Double precioML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 13, seleccion);
            ...
            //Escribe precio Ml neto como doble
            Double precioMLN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 14, seleccion);
            ...
            //Escribe comision ML como doble
            Double comisionML = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 15, seleccion);
            ...
            //Escribe comison ML neta
            Double comisionMLN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 16, seleccion);
            ...
            //Escribe IVA * unidad
            Double iva = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 17, seleccion);
            ...
            //Escribe IVA neto
            Double ivaN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 18, seleccion);
            ...
            //Escribe utilidadShop * unidad
            Double utilidadShop = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 19, seleccion);
            ...
            //Escribe utilidadShop neta
            Double utilidadShopN = LeerExcel.obtenerCeldaNumerica("src//excel/INVENTARIOS.xlsx", inventario10, 20, seleccion);
    ...
    public static void devolverUltimaVenta(String fechaCHH) throws IOException {
        ...
        try {
            ...
            //Escribe precio shop*unidad como double
            Double precioShop = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 11, seleccion);
            ...
            //Escribe precio shop neto como doble
            Double precioShopN = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 12, seleccion);
            ...
            //Escribe precio Ml por unidad como doble
            Double precioML = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 13, seleccion);
            ...
            //Escribe precio Ml neto como doble
            Double precioMLN = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 14, seleccion);
            ...
            //Escribe comision ML como doble
            Double comisionML = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 15, seleccion);
            ...
            //Escribe comison ML neta
            Double comisionMLN = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 16, seleccion);
            ...
            //Escribe IVA * unidad
            Double iva = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 17, seleccion);
            ...
            //Escribe IVA neto
            Double ivaN = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 18, seleccion);
            ...
            //Escribe utilidadShop * unidad
            Double utilidadShop = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 19, seleccion);
            ...
            //Escribe utilidadShop neta
            Double utilidadShopN = LeerExcel.obtenerCeldaNumerica("src//excel/Ventas.xlsx", fechaCHH, 20, seleccion);
