...
public class inventarioPrincipalCT extends javax.swing.JFrame {
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        try {
            ...
            EscribirCRM.escribirCeldaDouble(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos", Utilidades.roundTwoDecimals(0), LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos"), 3);
            String formula37 = "SUM(D2:D" + (LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos") + 1) + ")";
            EscribirCRM.escribirCeldaDouble(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos", Utilidades.roundTwoDecimals(Double.valueOf(data[6])), LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos"), 6);
            String formula38 = "SUM(G2:G" + (LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos") + 1) + ")";
            EscribirCRM.escribirFormula(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos", formula37, (LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos") + 1), 3);
            EscribirCRM.escribirFormula(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos", formula38, (LeerExcel.contarRenglones(rutas.excel+"\\LIBROS DE CONTROL.xlsx", "Gastos") + 1), 6);            

            EscribirCRM.escribirExcelInv(rutas.excel+"\\COMPRAS EN TRANSITO.xlsx", "COMPRAS",inventario,5);
            EscribirCRM.escribirCelda(rutas.excel+"\\COMPRAS EN TRANSITO.xlsx", "COMPRAS", tipoGasto.getSelectedItem().toString(), LeerExcel.contarRenglones(rutas.excel+"\\COMPRAS EN TRANSITO.xlsx", "COMPRAS"), 21);
            EscribirCRM.escribirCelda(rutas.excel+"\\COMPRAS EN TRANSITO.xlsx", "COMPRAS", paqueteria.getText(), LeerExcel.contarRenglones(rutas.excel+"\\COMPRAS EN TRANSITO.xlsx", "COMPRAS"), 22);
            Libros.actualiza();
            //UNIDADES
