...
public class Provedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtWpp = new javax.swing.JTextField();
        jlUnidades = new javax.swing.JLabel();
        jtCorreo = new javax.swing.JTextField();
        jlTIG1 = new javax.swing.JLabel();
        ...
        jLabel1.setText("REGISTRAR NUEVO PROVEDOR");
        ...
        jlCosto.setText("PRODUCTO");
        jpPack.add(jlCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 140, 30));
        ...
        jpPack.add(jtProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 320, 48));
        ...
        jtWpp.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 18)); // NOI18N
        jtWpp.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jpTIG.add(jtWpp, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 110, 48));
        jtCosto.setBackground(Colores.epicColorBajito);
        ...
        jlUnidades.setText("CORREO");
        jpTIG.add(jlUnidades, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 110, 30));
        ...
        jpTIG.add(jtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 150, 48));
        jtCorreo.setBackground(Colores.epicColorBajito);

        jlTIG1.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 24)); // NOI18N
        jlTIG1.setForeground(new java.awt.Color(255, 255, 255));
        jlTIG1.setText("WPP");
        jpTIG.add(jlTIG1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 60, 30));
        ...
        jpUbicacion.add(jtUbicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 220, 48));
        jtCosto.setBackground(Colores.epicColorBajito);

        jlTIG.setFont(new java.awt.Font("Franklin Gothic Heavy", 0, 24)); // NOI18N
        jlTIG.setForeground(new java.awt.Color(255, 255, 255));
        jlTIG.setText("UBICACION");
        jpUbicacion.add(jlTIG, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 130, 30));
        ...
        jpUbicacion.add(jtCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 40, 48));
        jtCosto.setBackground(Colores.epicColorBajito);
    ...
    private void jbRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRegistrarMouseClicked
        ...
        String [] provedor = {jtNombre.getText(), jtProducto.getText(),jtWpp.getText(), jtCorreo.getText(),
                                jtUbicacion.getText()};
    ...
    private javax.swing.JLabel jlTIG1;
    ...
    private javax.swing.JTextField jtWpp;
